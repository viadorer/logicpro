  ...
  const insertAll = db.transaction(() => {
    for (let i = 0; i < listings.length; i++) {
      ...
      const row = {
        ...
        parking_lots: l.parking_lots ?? 0, garage: l.garage ?? 0,
